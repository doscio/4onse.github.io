...
var  subscribeImage = jQuery('#objective').data('background-image');
var  contactImage = jQuery('#desired').data('background-image');
var  partnersImage = jQuery('#partners').data('background-image');
...
if (subscribeImage) {  jQuery('#objective').css({ 'background-image':'url(' + subscribeImage + ')' }); };
if (contactImage) {  jQuery('#desired').css({ 'background-image':'url(' + contactImage + ')' }); };
if (partnersImage) {  jQuery('#partners').css({ 'background-image':'url(' + partnersImage + ')' }); };
...
jQuery(document).ready(function($) {
	...
	$('.next-section .go-to-about').click(function() {
  	...
  	$('.next-section .go-to-objective').click(function() {
    	$('html,body').animate({scrollTop:$('#objective').offset().top}, 1000);
  	});
  	$('.next-section .go-to-desired').click(function() {
    	$('html,body').animate({scrollTop:$('#desired').offset().top}, 1000);
  	});
  	$('.next-section .go-to-partners').click(function() {
    	$('html,body').animate({scrollTop:$('#partners').offset().top}, 1000);
  	});
  	$('.next-section .go-to-participate').click(function() {
    	$('html,body').animate({scrollTop:$('#participate').offset().top}, 1000);
  	});
